...
try:
    ...
    print("1. Email Str validation",user_email)
...
try:
    ...
    print("2. URL validation\n", user_resource, user_resource.http_url)
except ValueError as e:
    print(f"Validation error: {e}")


'''3. IP Addresses validation
IP Addresses
https://docs.pydantic.dev/2.8/api/networks/
...
try:
    ...
    print("3. IP Addresses validation\n", device)
except ValueError as e:
    print(e)
